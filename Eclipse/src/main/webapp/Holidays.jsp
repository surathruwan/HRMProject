		...
		<div class="FormLayout">
			...
			<div class="FullSizeLayout">
				<table class="table table-hover">
					<thead>
						<tr>
							...
							<th scope="col" bgcolor="#5fc1e8">Full Day /Half Day / Not
								Working</th>
				...
				<button type="submit" class="btn btn-danger"
					style="float: right; margin-left: 0.5%; margin-bottom: 1%;">DELETE</button>
				<button type="button" class="btn btn-info " data-toggle="modal"
					style="float: right; margin-bottom: 1%;" data-target="#myModal">ADD</button>
					...
					<div class="modal-dialog">
						...
						<div class="modal-content">
							...
							<div class="modal-body" style="background-color: #e6f9ff">
								...
								<div class="form-group">
									<label class="col-form-label" for="inputDefault">Date</label> <input
										type="date" class="form-control">
								</div>

								<div class="form-group">
									<label for="exampleSelect1">Full Day/Half Day</label> <select
