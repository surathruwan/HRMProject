		...
		<div class="FormLayout">
			<div class="FullSizeLayoutCenter">
				...
				<div style="width: 100%">
					<form method="post" id="register-form">
						<fieldset class="well the-fieldset">
							<legend class="the-legend" style="font-size: 16px">Date
								Range</legend>

							<div class="form-group">
								<label for="FromDate">From</label> <input type="Date"
									class="form-control" name="StartDate" style="width: 80%">
							</div>
							...
							<div class="form-group">
								<label for="ToDate">To</label> <input type="Date"
									class="form-control" name="EndDate" style="width: 80%">
							</div>
				...
				<fieldset>
					...
					<div class="form-group">
						<label for="exampleSelect1">Monday</label> <select
					...
					<div class="form-group">
						<label for="exampleSelect1">Tuesday</label> <select
							class="form-control" id="exampleSelect1">
							<option>Full Day</option>
							<option>Half Day</option>
							<option>Not a Working Day</option>
					...
					<div class="form-group">
						<label for="exampleSelect1">Wednesday</label> <select
							class="form-control" id="exampleSelect1">
							<option>Full Day</option>
							<option>Half Day</option>
							<option>Not a Working Day</option>
					...
					<div class="form-group">
						<label for="exampleSelect1">Thursday</label> <select
							class="form-control" id="exampleSelect1">
							<option>Full Day</option>
							<option>Half Day</option>
							<option>Not a Working Day</option>
					...
					<div class="form-group">
						<label for="exampleSelect1">Friday</label> <select
							class="form-control" id="exampleSelect1">
							<option>Full Day</option>
							<option>Half Day</option>
							<option>Not a Working Day</option>
					...
					<div class="form-group">
						<label for="exampleSelect1">Saturday</label> <select
							class="form-control" id="exampleSelect1">
							<option>Full Day</option>
							<option>Half Day</option>
							<option>Not a Working Day</option>
					...
					<div class="form-group">
						<label for="exampleSelect1">Sunday</label> <select
							class="form-control" id="exampleSelect1">
							<option>Full Day</option>
							<option>Half Day</option>
							<option>Not a Working Day</option>
					...
					<button type="submit" class="btn btn-primary"
						style="margin-bottom: 2%">SAVE</button>
